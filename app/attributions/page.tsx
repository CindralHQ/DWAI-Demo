...
export default function AttributionsPage() {
  return (
    <div className="space-y-12">
      <section className="rounded-3xl bg-gradient-to-br from-indigo-700 via-indigo-800 to-slate-900 p-10 text-white shadow-lg">
        <p className="text-sm font-medium uppercase tracking-[0.4em] text-indigo-200">Credits</p>
      ...
      <section className="space-y-8 rounded-3xl border border-indigo-100 bg-white/90 p-10 shadow-sm backdrop-blur">
        <div className="space-y-3">
          ...
          <p className="text-base leading-7 text-slate-600">
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="font-semibold text-indigo-600 underline decoration-indigo-400 hover:text-indigo-700"
            >
              Freepik
            </Link>{' '}
            community.
          ...
          <div className="rounded-2xl bg-slate-100/70 p-4 text-sm text-slate-500 shadow-inner">
            ...
            <div className="mt-1">
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="text-indigo-600 underline decoration-indigo-400 hover:text-indigo-700"
              >
      ...
      <section className="rounded-3xl border border-indigo-100 bg-indigo-50/80 p-8 text-sm leading-7 text-indigo-900">
        <p>
