...
export default function CancelledOrderAdmin({
  items = undefined,
  ...
  return (
    <EmailLayout preview={preview} subject="Order cancelled" preheader="A customer cancelled an order.">
      <h1 style={styles.h1}>Order cancelled</h1>
      <p style={styles.p}>Hi {recipientName},</p>
      <p style={styles.p}>A customer cancelled an order. Review for refunds or access changes.</p>
      <DetailsTable
        rows={[
