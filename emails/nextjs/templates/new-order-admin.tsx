...
export default function NewOrderAdmin({
  ...
  return (
    <EmailLayout preview={preview} subject="New order placed" preheader="A customer placed a new order.">
      <h1 style={styles.h1}>New order</h1>
      <p style={styles.p}>Hi {recipientName},</p>
      <p style={styles.p}>A new order was placed. Review payment and fulfillment details.</p>
      <DetailsTable
        rows={[
